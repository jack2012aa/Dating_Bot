...
rich_menu = RichMenu(size = RichMenuSize(width = 1576, height = 1001),
 ...
 chat_bar_text = "查看更多",
 areas = [
    RichMenuArea(bounds = RichMenuBounds(x = 788, y = 0, width = 788, height = 120), action = RichMenuSwitchAction(label = "Switch menu", rich_menu_alias_id = "book_menu_2", data = "switch menu")),
...
line_bot_api.create_rich_menu_alias(RichMenuAlias("user_menu_2", rich_menu_id))
